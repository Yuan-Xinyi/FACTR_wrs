...
DEVICENAME1                 = '/dev/ttyUSB1'    # Check which port is being used on your controller
DEVICENAME2                 = '/dev/ttyUSB1'    # ex) Windows: "COM1"   Linux: "/dev/ttyUSB1" Mac: "/dev/tty.usbserial-*"
